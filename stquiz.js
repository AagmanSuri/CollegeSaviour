...
// Your web app's Firebase configuration
 // Your web app's Firebase configuration
 var firebaseConfig = {
    apiKey: "AIzaSyADM7GOvUJXkSzrWDE9Gld74FrvZklXhAE",
    authDomain: "quiz-bd5cc.firebaseapp.com",
    databaseURL: "https://quiz-bd5cc-default-rtdb.firebaseio.com",
    projectId: "quiz-bd5cc",
    storageBucket: "quiz-bd5cc.appspot.com",
    messagingSenderId: "560304239170",
    appId: "1:560304239170:web:c5104ad03d3c685c7db3db"
  };
  // Initialize Firebase
...
function AddItemsToTable(sub,b1 ,blink1, blink2, blink3, blink4){
    ...
    td1.innerHTML=sub;
    td2.innerHTML="<a href='"+blink1 +"' >"+ " quiz" +"</a>";
    td3.innerHTML="<a href='"+blink2 +"' >"+ " quiz" +"</a>";
    td4.innerHTML="<a href='"+blink2 +"' >"+ " quiz" +"</a>";
    td5.innerHTML="<a href='"+blink2 +"' >"+ " quiz" +"</a>";
